document.addEventListener('DOMContentLoaded', function () {
    ...
    <header>
        ...
        <a href="carrinho.html" class="cart-mobile">
        ...
        <nav class="nav-center">
            <a href="index.html" ${pagina === 'index.html' || pagina === '' ? 'class="active"' : ''}>Início</a>
            <a href="catalogo.html" ${pagina === 'catalogo.html' ? 'class="active"' : ''}>Catálogo</a>
            <a href="parceria.html" ${pagina === 'parceria.html' ? 'class="active"' : ''}>Parceria</a>
            <a href="informacoes.html" ${pagina === 'informacoes.html' ? 'class="active"' : ''}>Informações</a>
        </nav>

        <div class="nav-right">
            <a href="carrinho.html">Carrinho <span id="cart-count"></span></a>
    ...
    <div class="mobile-menu" id="mobile-menu">
        ...
        <a href="parceria.html">Parceria</a>
    ...
    // Injeta o header no body
    document.body.insertAdjacentHTML('afterbegin', headerHTML);

    // Função do menu hambúrguer (precisa estar no escopo global)
